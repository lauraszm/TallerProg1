...
public class Socio {
		...
		public boolean esVitalicio() {
			return Tipo == TipoSocio.VITALICIO;
		}
		
		@Override
		public String toString() {
			return "Socio [nro_socio=" + nro_socio + ", nombre_completo=" + nombre_completo + ", fecha_alta="
					+ fecha_alta + ", direccion=" + direccion + ", telefono=" + telefono + ", Tipo=" + Tipo + "]";
		}
